...
export default function MainFooter() {
  return (
      <footer className="w-full pb-6 px-20 bg-gradient-to-b from-zinc-900 to-zinc-800 via-zinc-900 shadow-xl mt-auto flex">
        ...
        <div className="w-min rounded-full overflow-hidden my-10 bg-zinc-300 ring ring-gray-700 ml-auto p-10">
